...
class 分型结构(IntEnum):
    ...
    散: int
    @classmethod
    def 分析(cls, 左: Any, 中: Any, 右: Any, 可以逆序包含: bool = False, 忽视顺序包含: bool = False) -> "分型结构": ...
...
class K线:
    ...
    @classmethod
    def 创建普K(cls, 标识: str, 时间戳: int, 开盘价: float, 高: float, 低: float, 收盘价: float, 成交量: float, 序号: int = 0, 周期: int = 0) -> "K线": ...
...
class 笔(虚线):
    ...
    @classmethod
    def 分析(cls, 初始分型: 分型 | None, 分型序列: "动态数组", 笔序列: "动态数组", 缠K序列: "动态数组", 普K序列: "动态数组", 配置: "缠论配置") -> None: ...
    @classmethod
    def 获取缠K数量(cls, 缠K序列: "动态数组", 笔序列: "动态数组", 配置: "缠论配置") -> int: ...
    @classmethod
    def 次高(cls, 缠K序列: "动态数组", 笔内相同终点取舍: bool = False) -> 缠论K线 | None: ...
    @classmethod
    def 次低(cls, 缠K序列: "动态数组", 笔内相同终点取舍: bool = False) -> 缠论K线 | None: ...
    @classmethod
    def 实际高点(cls, 缠K序列: "动态数组", 笔内相同终点取舍: bool = False) -> 缠论K线 | None: ...
    @classmethod
    def 实际低点(cls, 缠K序列: "动态数组", 笔内相同终点取舍: bool = False) -> 缠论K线 | None: ...
    @classmethod
    def 以文会友(cls, 笔序列: "动态数组", 文: 分型) -> "笔 | None": ...
    @classmethod
    def 以武会友(cls, 笔序列: "动态数组", 武: 分型) -> "笔 | None": ...
    @classmethod
    def 根据缠K找笔(cls, 笔序列: "动态数组", 缠K: 缠论K线, 偏移: int = 0) -> "笔 | None": ...
...
class 线段(虚线):
    ...
    def 创建线段(cls, arr: "动态数组") -> "线段": ...
    @classmethod
    def 分析(cls, 笔序列: "动态数组", 线段序列: "动态数组", 配置: "缠论配置") -> None: ...
...
class 线段特征:
    ...
    owns: bool
    @classmethod
    def 静态分析(cls, 虚线序列: "动态数组", 方向: int, 四象: str, 是否忽视: bool, 结果: "动态数组") -> None: ...
...
class 中枢:
    ...
    def 获取序列(self) -> "动态数组": ...
    @classmethod
    def 分析(cls, 虚线序列: "动态数组", 中枢序列: "动态数组", 跳过首部: bool = True, 标识: str = "hub") -> None: ...
...
class K线合成器:
    ...
    def __init__(self, 标识: str, 周期组: list[int], 事件回调: Any = None) -> None: ...
    def 投喂(self, 时间戳: int, 开: float, 高: float, 低: float, 收: float, 量: float) -> None: ...
    def 投喂K线(self, K线: K线) -> None: ...
    def 设置事件回调(self, 回调: Any) -> None: ...
    def 获取当前K线(self, 周期: int) -> K线 | None: ...

class 立体分析器:
    """多级别联立分析器。将输入周期K线合成到多周期，每个周期独立分析。"""
    ...
    def __init__(self, 符号: str, 周期组: list[int], 配置: 缠论配置 | None = None, 配置组: dict[int, 缠论配置] | None = None) -> None: ...
    def 投喂K线(self, 普K: K线) -> None: ...
    def 测试_保存数据(self) -> None: ...

class 背驰分析:
    """Divergence analysis (背驰分析) — static namespace matching chan.py 背驰分析."""
    @classmethod
    def MACD背驰(cls, 进入段: 虚线, 离开段: 虚线, 普K序列: 动态数组, 方式: str = "default") -> bool: ...
    @classmethod
    def 斜率背驰(cls, 进入段: 虚线, 离开段: 虚线) -> bool: ...
    @classmethod
    def 测度背驰(cls, 进入段: 虚线, 离开段: 虚线) -> bool: ...
    @classmethod
    def 全量背驰(cls, 进入段: 虚线, 离开段: 虚线, 普K序列: 动态数组) -> bool: ...
    @classmethod
    def 任意背驰(cls, 进入段: 虚线, 离开段: 虚线, 普K序列: 动态数组) -> bool: ...
    @classmethod
    def 配置背驰(cls, 进入段: 虚线, 离开段: 虚线, 普K序列: 动态数组, 配置: 缠论配置) -> bool: ...
    @classmethod
    def 任选背驰(cls, 进入段: 虚线, 离开段: 虚线, 普K序列: 动态数组) -> bool: ...
    @classmethod
    def 背驰模式(cls, 进入段: 虚线, 离开段: 虚线, 普K序列: 动态数组, 配置: 缠论配置, 模式: str = "default") -> bool: ...
...
class 观察者:
    ...
    def 背驰_模式(self, 进入段: 虚线, 离开段: 虚线, 配置: 缠论配置 = None, 模式: str = "default") -> bool: ...
